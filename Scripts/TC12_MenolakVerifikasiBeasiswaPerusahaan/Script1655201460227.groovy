...
WebUI.setText(findTestObject('Object Repository/TC3_OR/Page_Tambah Beasiswa  Geratisin/input_Nama Beasiswa_name'), 'Beasiswa TC12')
...
WebUI.click(findTestObject('TC12_OR/Page_Beasiswa Saya  Geratisin/elm_Verifikasi'))
...
WebUI.click(findTestObject('TC12_OR/Page_Verifikasi Beasiswa  GERATISIN/elm_Verifikasi'))
...
WebUI.click(findTestObject('Case_Delete Resulting Data/button_Delete TC12'))
