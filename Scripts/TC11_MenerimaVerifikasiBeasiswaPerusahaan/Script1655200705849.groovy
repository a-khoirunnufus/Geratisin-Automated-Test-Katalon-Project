...
WebUI.setText(findTestObject('Object Repository/TC3_OR/Page_Tambah Beasiswa  Geratisin/input_Nama Beasiswa_name'), 'Beasiswa TC11')
...
WebUI.click(findTestObject('TC11_OR/Page_Beasiswa Saya  Geratisin/elm_Verifikasi'))
...
WebUI.setText(findTestObject('Object Repository/TC11_OR/Page_Login Admin  GERATISIN/input_GERATISIN ADMIN_username'), 'admin')

WebUI.setEncryptedText(findTestObject('Object Repository/TC11_OR/Page_Login Admin  GERATISIN/input_GERATISIN ADMIN_password'), 
    '8SQVv/p9jVScEs4/2CZsLw==')

WebUI.click(findTestObject('Object Repository/TC11_OR/Page_Login Admin  GERATISIN/button_Log in'))

WebUI.click(findTestObject('Object Repository/TC11_OR/Page_Dashboard  GERATISIN/a_Beasiswa'))

WebUI.click(findTestObject('Object Repository/TC11_OR/Page_Dashboard  GERATISIN/a_Verifikasi Beasiswa'))

WebUI.click(findTestObject('TC11_OR/Page_Verifikasi Beasiswa  GERATISIN/elm_Verifikasi'))

WebUI.click(findTestObject('Object Repository/TC11_OR/Page_Verifikasi Beasiswa  GERATISIN/button_Terima'))

WebUI.click(findTestObject('Object Repository/TC11_OR/Page_Verifikasi Beasiswa  GERATISIN/div_Verifikasi beasiswa telah berhasil, Bea_f67b0e'))

WebUI.verifyTextPresent('Verifikasi beasiswa telah berhasil', false)
...
WebUI.click(findTestObject('Case_Delete Resulting Data/button_Delete TC11'))
