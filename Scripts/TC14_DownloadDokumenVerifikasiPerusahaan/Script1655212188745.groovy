...
WebUI.setText(findTestObject('Object Repository/TC13_OR/Page_Mendaftar Perusahaan  Geratisin/input_Nama Perusahaan_name'), 
    'Perusahaan TCempatbelas')

WebUI.setText(findTestObject('Object Repository/TC13_OR/Page_Mendaftar Perusahaan  Geratisin/input_Email_email'), 'ptc14@email.com')
...
WebUI.setText(findTestObject('Object Repository/TC13_OR/Page_Login Perusahaan  Geratisin/input_Username_username'), 'ptc14')
...
WebUI.click(findTestObject('TC14_OR/Page_Verifikasi Perusahaan  GERATISIN/elm_Download'))
...
WebUI.click(findTestObject('TC14_OR/Page_Pengguna Perusahaan  GERATISIN/elm_Delete'))
